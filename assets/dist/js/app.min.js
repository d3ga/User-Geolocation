...
class ipData{constructor(){this.getData()}getData(){$.getJSON("https://ipinfo.io",e=>{this.initMap(e)})}initMap(e){let n={lat:Number(e.loc.split(",")[0]),lng:Number(e.loc.split(",")[1])},t=new google.maps.Map(document.getElementById("map"),{center:n,zoom:15,minZoom:1}),o=new google.maps.Marker({position:n,map:t});let a=`\n      <div>\n        <h6 class="text-center">Estimated position based on IP</h6>\n        <table class="table">\n          <tbody>\n          ${[{name:"City",key:"city"},{name:"Region",key:"region"},{name:"Country",key:"country"},{name:"Zipcode",key:"postal"},{name:"IP Address",key:"ip"},{name:"Provider",key:"org"},{name:"Geolocation",key:"loc"}].map(n=>e[n.key]?`\n              <tr>\n                <th scope="row">${n.name}</th>\n                <td>${e[n.key]}</td>   \n              </tr>\n            `:"").join("")}\n        </tbody>\n      </table>\n      <div class="text-right">\n        <span class="text-right">\n          <a class="code-link" href="https://github.com/d3ga/user-geolocation-info" target="_blank" rel="noopener">&lt;/code&gt;</a>\n        </span>\n      </div>\n    </div>`,i=new google.maps.InfoWindow({content:a});i.open(t,o),o.addListener("click",function(){i.open(t,o)})}}let run=new ipData;