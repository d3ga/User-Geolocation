...
class ipData{constructor(){this.getData()}getData(){$.getJSON("https://ipinfo.io",t=>{this.initMap(t)})}initMap(t){let n={lat:Number(t.loc.split(",")[0]),lng:Number(t.loc.split(",")[1])},o=new google.maps.Map(document.getElementById("map"),{center:n,zoom:15,minZoom:1}),e=new google.maps.Marker({position:n,map:o}),r=`<div>\n                          <h6 class="text-center">Estimated position based on IP</h6>\n                          <table class="table">\n                            <tbody>\n                              <tr>\n                                <th scope="row">City</th>\n                                <td>${t.city}</td>   \n                              </tr>\n                              <tr>\n                                <th scope="row">Region</th>\n                                <td>${t.region}</td>   \n                              </tr>\n                              <tr>\n                                <th scope="row">Country</th>\n                                <td>${t.country}</td>   \n                              </tr>\n                              <tr>\n                                <th scope="row">Postal Code</th>\n                                <td>${t.postal}</td>   \n                              </tr>\n                              <tr>\n                                <th scope="row">IP</th>\n                                <td>${t.ip}</td>   \n                              </tr>\n                              <tr>\n                                <th scope="row">Provider</th>\n                                <td>${t.org}</td>   \n                              </tr>\n                              <tr>\n                                <th scope="row">Geolocation</th>\n                                <td>${t.loc}</td>   \n                              </tr>\n                            </tbody>\n                          </table>\n                          <div class="text-right">\n                            <span class="text-right">coded by\n                              <a href="https://kostasdegaitas.de" target="_blank" rel="noopener">d3ga</a>\n                            </span>\n                          </div>\n                        </div>`,a=new google.maps.InfoWindow({content:r});a.open(o,e),e.addListener("click",function(){a.open(o,e)})}}let run=new ipData;